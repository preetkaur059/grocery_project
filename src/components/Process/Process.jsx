...
const Steps = [
    {
        ...
        title: 'Sourcing',
        para:'We collect fresh products from trusted farms and reliable suppliers.',
        icon: <PiPlant/>,
    },
    {
        id: 1,
        ...
        title: 'Manufacturing',
        para:'Products are processed carefully using safe and modern methods.',
        icon: <PiFactory />,
    },
    {
        id: 2,
        ...
        para:'Every item is checked properly to maintain quality and freshness.',
        icon: <SlBadge/>,
    },
    {
        id: 3,
        ...
        title: 'Logistics',
        para:'We deliver products quickly and safely to your doorstep.',
        icon:<BsTruck/>,
    },
]
